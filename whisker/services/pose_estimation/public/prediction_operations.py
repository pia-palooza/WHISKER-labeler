    ...
    def get_pose_predictions(
        ...
        if dataset.type == DatasetType.VIDEO_COLLECTION:
            ...
            if dataset_predictions[video_stem] is None:
                ...
                logging.info(f"Loaded pose predictions for run '{training_run_name}', dataset '{dataset_name}', video '{video_stem}'")
            ...
            if dataset_predictions[None] is None:
                logging.info(f"Loaded pose predictions for run '{training_run_name}', dataset '{dataset_name}'")
